            ...
            <div className="grid grid-cols-2 gap-4">
              <div>
                ...
                <input
                  type="text"
                  defaultValue="John"
                  className="w-full px-4 py-2.5 border border-gray-300 rounded-lg" style={{ outline: 'none' }}
                />
              </div>
              <div>
          ...
          <div className="p-6 space-y-4">
            ...
            <div className="flex items-start gap-2 p-4 bg-amber-50 border border-amber-200 rounded-lg">
              <div className="text-sm text-amber-900">
                <strong>Important:</strong> Keep your API keys secure and never share them publicly. If you suspect a key has been compromised, regenerate it immediately.
              </div>
            </div>
          </div>
        </div>
          ...
          <div className="p-6 space-y-4">
            <div>
              ...
              <input
                ...
                className="w-full px-4 py-2.5 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-transparent"
              />
              <p className="text-sm text-gray-500 mt-2">This will appear as the sender for your SMS messages. Can be alphanumeric (up to 11 characters) or a phone number.</p>
            </div>
          </div>
        </div>
          ...
          <div className="p-6 space-y-4">
            <div className="flex items-center justify-between pb-4 border-b border-gray-200">
              <div>
                ...
                <div className="text-sm text-gray-600">Receive email alerts for campaign completions and failures</div>
              </div>
            ...
            <div className="flex items-center justify-between pb-4 border-b border-gray-200">
              <div>
                <div className="font-medium text-gray-900">Auto-reply Detection</div>
                <div className="text-sm text-gray-600">Automatically detect and categorize auto-replies</div>
              </div>
              <label className="relative inline-flex items-center cursor-pointer">
                <input type="checkbox" defaultChecked className="sr-only peer" />
                <div className="w-11 h-6 bg-gray-200 peer-focus:outline-none peer-focus:ring-4 rounded-full peer peer-checked:after:translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:left-[2px] after:bg-white after:border-gray-300 after:border after:rounded-full after:h-5 after:w-5 after:transition-all" style={{ '--tw-ring-color': 'rgba(255, 95, 31, 0.3)' } as any}></div>
            ...
            <div className="flex items-center justify-between">
              <div>
                <div className="font-medium text-gray-900">STOP Request Handling</div>
                <div className="text-sm text-gray-600">Automatically unsubscribe contacts who send STOP</div>
              </div>
              <label className="relative inline-flex items-center cursor-pointer">
                <input type="checkbox" defaultChecked className="sr-only peer" />
                <div className="w-11 h-6 bg-gray-200 peer-focus:outline-none peer-focus:ring-4 rounded-full peer peer-checked:after:translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:left-[2px] after:bg-white after:border-gray-300 after:border after:rounded-full after:h-5 after:w-5 after:transition-all" style={{ '--tw-ring-color': 'rgba(255, 95, 31, 0.3)' } as any}></div>
